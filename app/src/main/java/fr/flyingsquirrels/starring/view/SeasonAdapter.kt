...
import kotlinx.android.synthetic.main.adapter_seasons.view.*
        ...
        inner class Holder(itemView: View?) : RecyclerView.ViewHolder(itemView) {
            fun bind(season: Season) {
                ...
                itemView.setOnClickListener {
                    ...
                    var options: Bundle? = ActivityOptionsCompat.makeSceneTransitionAnimation(it.context as Activity, it.portrait, DetailActivity.EXTRA_SHARED_SEASON).toBundle()
                    val extras = Bundle()
                    ...
                    extras.putParcelable(DetailActivity.EXTRA_MEDIA, season)
